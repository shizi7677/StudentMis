...
public class ManageDemoFrame extends JInternalFrame {
	...
	public ManageDemoFrame() throws HeadlessException {
...
//		
	...
	private void showData() {
		...
		String [] colName = {"学生编号", "学生班级","学生名称", "性别", "生日", "联系方式","家庭住址"};
		
		for (int i = 0; i < students.size(); i++) {
			datas[i][0] = students.get(i).getStudentNumber ();
			datas[i][1] = students.get(i).getClazzNumber();
